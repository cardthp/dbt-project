This Project is using dbt tools to create about a Transcation and Customer detail in store name "Jaffle Shop" dataset and connected with Google Bigquery 
